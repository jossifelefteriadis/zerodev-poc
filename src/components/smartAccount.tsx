  ...
  return (
    <section className="w-full flex justify-center px-4">
      ...
      <button
        ...
        >
        {status === 'running' ? 'Sending…' : 'Create Smart Account & Send UserOp'}
      ...
      <section className="mt-4 space-y-1 text-sm">
        {status === 'error' && <p className="text-red-400"><b>Error:</b> {result.error}</p>}
        {result.accountAddress && (
          <>
            <p><b>Account:</b> <a href={`https://sepolia.etherscan.io/address/${result.accountAddress}`} target="_blank" rel="noreferrer">https://sepolia.etherscan.io/address/{result.accountAddress}</a></p>
            <p><b>UserOp:</b> {result.userOpHash}</p>
            <p><b>Bundler Tx:</b> <a href={`https://sepolia.etherscan.io/tx/${result.bundlerTxHash}`} target="_blank" rel="noreferrer">https://sepolia.etherscan.io/tx/{result.bundlerTxHash}</a></p>
          </>
        )}
      </section>
      </section>
